...
<div class="container">
    ...
    <form action="{{ route('car.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="kendaraan" id="kendaraan" class="form-control" required autocomplete="off">
        </div>
        <div class="mb-3">
            <label for="plat_nomor" class="form-label">Nomor Plat</label>
            <input type="text" name="plat_nomor" id="plat_nomor" class="form-control" required autocomplete="off">
        </div>
